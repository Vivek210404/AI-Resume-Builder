          ...
          {data.map((experience, index) => (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <input value={experience.company || ""} onChange={(e)=>updateExperience(index,"company",e.target.value)} type="text" className="px-3 py-2 text-sm rounded-lg" placeholder="Company Name" />
                <input value={experience.position || ""} onChange={(e)=>updateExperience(index,"position",e.target.value)} type="text" className="px-3 py-2 text-sm rounded-lg" placeholder="Job Title" />
